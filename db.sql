...
INSERT INTO `persona` VALUES (1,'JOHN FELIPE','VARGAS','PERDOMO','M','JOHNFE66@GMAIL.COM','CC','94552499',1),(2,'cris','black','metal','M','235werwer','CC','1075299691',1);
...
CREATE TABLE `role_has_permisos` (
  ...
  CONSTRAINT `fk_role_has_permisos_role1` FOREIGN KEY (`idrole`) REFERENCES `roles` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `roles` VALUES (1,'INSTRUCTOR','INSTRUCTOR DEL ADSI');
...
CREATE TABLE `usuario` (
  ...
  CONSTRAINT `fk_usuario_role1` FOREIGN KEY (`idrole`) REFERENCES `roles` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping events for database 'selp'
--
...
-- Dump completed on 2017-08-23 12:50:51
